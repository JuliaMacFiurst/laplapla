    ...
    soundCase: {
      ...
      stage04: {
        print: {
          ...
          legendTitle: string;
          gestureLabels: { clap: string; snap: string; "knee-pat": string; pause: string };
          snapAlternative: string;
          levelLabel: string;
          secretBackInstruction: string;
          scanQrLabel: string;
          levelSixTitle: string;
          levelSixInstruction: string;
          hostKeyTitle: string;
          hostKeyWarning: string;
          boxLab: string;
          boxReminderTitle: string;
          boxReminder: readonly string[];
          boxContents: string;
          printHelpTitle: string;
        ...
        digital: {
          ...
          stageLabel: string;
          wrongTitle: string;
          wrongNamedPrefix: string;
          wrongNamedSuffix: string;
          wrongGeneric: string;
          wrongLines: readonly string[];
          wrongNextTitle: string;
          wrongSteps: readonly string[];
          wrongParrotLine: string;
          correctTitle: string;
          correctNamedSuffix: string;
          correctGeneric: string;
          checkTitle: string;
          question: string;
          asyncLabel: string;
          ...
          prompt: string;
          challenge: string;
          experimentSteps: readonly string[];
          explanation: readonly string[];
          clueTitle: string;
          clueLines: readonly string[];
          parrotLines: readonly string[];
          nextTitle: string;
          phoneAway: string;
          findSamples: string;
          adultSetup: string;
